<?php
	...
	$columns = array(
        ...
        'formatter' => function( $d, $row ) 
        {
			...
			$action_buttons.= "<button type='submit' class='btn btn-warning' id='btn-archive' name='btnarchive' data-toggle='tooltip' data-placement='top' title='Restore this Journal'  onclick='unarchive({$d});'><i class='fa fa-file-archive-o'> </i></button>";
